...
import type { DataItem, Signer, createData, deepHash, getCryptoDriver, stringToBuffer, DataItemCreateOptions, bundleAndSignData } from "@dha-team/arbundles";
...
export type ARxTransaction = {
  ...
  // fromRaw(rawTransaction: Buffer, ARxInstance: ARx): ARxTransaction;
} & DataItem;
export type ARxTransactonCtor = new (
  data: string | Uint8Array,
  ARx: Pick<ARx, "uploader" | "tokenConfig" | "arbundles">,
...
export type UploadResponse = {
  ...
  // The receipt version
  version: "1.0.0";
  // Injected verification function (same as Utils/ARx.verifyReceipt)
...
export type ARxTransactionCreateOptions = DataItemCreateOptions & { dataIsRawTransaction?: boolean };
